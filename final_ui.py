...
class Ui_Form(QtWidgets.QWidget):
	...
	def setupUi(self, Form):
		...
		self.gridLayout.addWidget(self.frame_4, 3, 1, 1, 2)
		self.frame_7 = QtWidgets.QFrame(Form)
		self.frame_7.setMinimumSize(QtCore.QSize(453, 71))
		self.frame_7.setMaximumSize(QtCore.QSize(453, 71))
		self.frame_7.setFrameShape(QtWidgets.QFrame.StyledPanel)
		self.frame_7.setFrameShadow(QtWidgets.QFrame.Raised)
		self.frame_7.setObjectName("frame_7")
		self.groupBox = QtWidgets.QGroupBox(self.frame_7)
		self.groupBox.setGeometry(QtCore.QRect(10, 0, 431, 61))
		font = QtGui.QFont()
		font.setPointSize(11)
		...
		self.LBL_Found = QtWidgets.QLabel(self.groupBox)
		self.LBL_Found.setEnabled(True)
		self.LBL_Found.setGeometry(QtCore.QRect(280, 30, 141, 20))
		self.LBL_Found.setText("")
		self.LBL_Found.setAlignment(QtCore.Qt.AlignCenter)
		...
		self.gridLayout.addWidget(self.frame_5, 0, 2, 3, 1)
		...
		self.gridLayout.addWidget(self.frame_6, 4, 0, 1, 3)
		...
		self.frame.setMinimumSize(QtCore.QSize(453, 200))
		self.frame.setMaximumSize(QtCore.QSize(453, 200))
		...
		self.GB_1.setGeometry(QtCore.QRect(11, 11, 431, 181))
		font = QtGui.QFont()
		font.setPointSize(11)
		...
		self.value_status.setGeometry(QtCore.QRect(170, 120, 91, 16))
		...
		self.value_battery.setGeometry(QtCore.QRect(170, 150, 91, 16))
		...
		self.INP_port.setGeometry(QtCore.QRect(70, 80, 121, 26))
		...
		self.BTN_connect.setGeometry(QtCore.QRect(210, 60, 95, 35))
		...
		self.title_1.setGeometry(QtCore.QRect(50, 20, 91, 21))
	...
	def retranslateUi(self, Form):
		...
		self.groupBox.setTitle(_translate("Form", " Search Object"))
		self.INP_Obj_Name.setStyleSheet(_translate("Form", "background-color:#292929;\n"
												   "color:#ffffff;\n"
												   "font-family:Trebuchet MS;\n"
												   "font-size:12px; \n"
												   "border-radius:2px;"))
		self.LBL_36.setText(_translate("Form", "Object Name:"))
	...
	def connect(self):
		...
		if utilities.validateIP(self.vehicleIP) and utilities.validatePort(self.vehiclePort):
			...
			try:
				...
				self.imageSocket = threading.Thread(target=utilities.imageRecievingClient, args=(
					self, self.vehicleIP, self.vehiclePort, self.feedTypeStatus, self.imageHolderList, self.processingDataHolder, self.processedImagesHolder,), daemon=True)
	...
	def startSearch(self):
		navigation_input_dict = {"frontDist": self.INP_front_length.text(), "backDist": self.INP_back_length.text(
		), "rightDist": self.INP_right_length.text(), "leftDist": self.INP_left_length.text()}
		mapping_input_dict = {"model": self.INP_model.text(), "bubble": self.INP_bubble.text(), "block": self.INP_block.text(
		), "point": self.INP_point.text(), "cloud": self.INP_cloud.text(), "slant": self.INP_slant.text()}
			...
			try:
				...
				with concurrent.futures.ThreadPoolExecutor() as executor:
					future = executor.submit(
						utilities.sendDataThroughSocket, self.datasendIP, self.datasendPort, "startExplore", distanceData)
	...
	def abortSearch(self):
		...
		if self.searchStatus == 1 and self.connectionStatus == 1 and self.checkSystemStatus == 0:
			try:
				with concurrent.futures.ThreadPoolExecutor() as executor:
					future = executor.submit(
						utilities.sendDataThroughSocket, self.datasendIP, self.datasendPort, "abortExplore", "")
					status = future.result()
					if status == True:
						self.searching = 0
						self.searchStatus = 0
	...
	def checkSystem(self):
		if self.searchStatus != 1 and self.connectionStatus == 1 and self.checkSystemStatus == 0:
			try:
				...
				with concurrent.futures.ThreadPoolExecutor() as executor:
					future = executor.submit(
						utilities.sendDataThroughSocket, self.datasendIP, self.datasendPort, "checkSystem", "")
					status = future.result()
					if status == True:
						QtWidgets.QMessageBox.information(
							self, "Check System", "Check System Successful")
						self.checkSystemStatus = 0
						self.value_18.setText("IDLE")
						self.value_18.setStyleSheet('color:#e91;')
					else:
						QtWidgets.QMessageBox.information(
							self, "Check System", "Check System Failed")
						self.checkSystemStatus = 0
	...
	def manualControl(self):
		if self.manualControlStatus == 0 and self.connectionStatus == 1 and self.checkSystemStatus == 0:
			try:
				with concurrent.futures.ThreadPoolExecutor() as executor:
					future = executor.submit(utilities.sendDataThroughSocket, (
						self.datasendIP, self.datasendPort, "manualControlChange", True))
					status = future.result()
					if status == True:
	...
	def export(self):
		path = QtWidgets.QFileDialog.getOpenFileName(
			self, 'Save Model', ClientData.modelValues.exportPath, "OBJ files (*.obj)")
