...
"font-size:14px; ")
        ...
        self.verticalLayout_2.addWidget(self.BTN_explore_3, 0, QtCore.Qt.AlignHCenter)
...
"font-size:14px; ")
        ...
        self.verticalLayout_2.addWidget(self.BTN_explore, 0, QtCore.Qt.AlignHCenter)
...
"font-size:15px;")
        ...
        self.horizontalLayout.addWidget(self.BTN_search, 0, QtCore.Qt.AlignHCenter)
        self.BTN_abort_search = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        self.BTN_abort_search.setMinimumSize(QtCore.QSize(180, 26))
        self.BTN_abort_search.setObjectName("BTN_abort_search")
        self.horizontalLayout.addWidget(self.BTN_abort_search, 0, QtCore.Qt.AlignHCenter)
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(self.frame_2)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(10, 570, 431, 28))
        ...
        self.horizontalLayout_2.addWidget(self.BTN_check, 0, QtCore.Qt.AlignHCenter)
        ...
        self.horizontalLayout_2.addWidget(self.BTN_MC, 0, QtCore.Qt.AlignHCenter)
        ...
        self.horizontalLayout_17.addWidget(self.LBL_33, 0, QtCore.Qt.AlignRight)
        ...
        self.horizontalLayout_17.addWidget(self.value_19, 0, QtCore.Qt.AlignLeft)
